...
#pragma warning disable
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if(isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v7.62</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v7.62</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
...
#region COLOR SPACE
        ...
        private void ApplyExtraOptionsForLOD(GameObject lodObject)
        {
            ...
            {
                var backup = lodObject.GetComponent<UnityMeshSimplifier.LODBackupComponent>();
