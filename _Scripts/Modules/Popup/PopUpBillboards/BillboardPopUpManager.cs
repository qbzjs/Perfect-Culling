...
[UIPanelPrefabAttr("BillboardPopUp", "PopupCanvas")]
public class BillboardPopUpManager : BasePanel
{
    [SerializeField] private List<Image> list_Step;
    ...
    [SerializeField] private Button btX;
    ...
    private void SetActiveStep(Image image, bool active)
    {
        if (image != null)
        {
            if (active)
